...
% while(iter < tracking_param.max_iter || error >  tracking_param.max_err)
while(iter < tracking_param.max_iter  && norm(x) > tracking_param.max_x && norm(residues) > tracking_param.max_err)
	% Current patch
