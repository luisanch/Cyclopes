...
base_path = 'C:/Users/Vipul/Documents/MIR/Visual Slam/SLAM/';
capture_params.homedir = append(base_path, 'cyclopes/');
%Car has left and right images
capture_params.data_dir = append(base_path, 'Versailles_canyon/Left/');
